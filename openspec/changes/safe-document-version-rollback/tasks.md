...
- [x] 3.3 Добавить в редактор точку входа «Откат версии» и rollback-режим сравнения: текущая версия слева заблокирована, справа доступна цель, перед сохранением виден diff; `POST` защищён CSRF, а после успеха открыт обновлённый редактор.
...
- [x] 4.5 Integration/UI: редактор видит текущую и целевую версии в rollback-режиме, получает 201 и возвращается в обновлённый редактор; читатель получает 403.
